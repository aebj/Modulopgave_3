...
--
ALTER TABLE `deals_costumers_employees_costumer_contacts`
  ADD CONSTRAINT `fk_costumer_contacts_costumer_contacts_id_idx` FOREIGN KEY (`costumer_contacts_id`) REFERENCES `costumer_contacts` (`id`),
  ADD CONSTRAINT `fk_costumers_costumers_id_idx` FOREIGN KEY (`costumers_id`) REFERENCES `costumers` (`id`),
  ADD CONSTRAINT `fk_deals_deals_id_idx` FOREIGN KEY (`deals_id`) REFERENCES `deals` (`id`),
  ADD CONSTRAINT `fk_employess_employees_id_idx` FOREIGN KEY (`employees_id`) REFERENCES `employees` (`id`);
